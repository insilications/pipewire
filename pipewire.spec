...
Version  : 0.3.4
Release  : 8
URL      : https://github.com/PipeWire/pipewire/archive/0.3.4/pipewire-0.3.4.tar.gz
Source0  : https://github.com/PipeWire/pipewire/archive/0.3.4/pipewire-0.3.4.tar.gz
...
%prep
%setup -q -n pipewire-0.3.4
cd %{_builddir}/pipewire-0.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588279929
...
cp %{_builddir}/pipewire-0.3.4/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.4/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/1d2540d6544e3a72dd4de79c394aad35e690dc7a
cp %{_builddir}/pipewire-0.3.4/pipewire-pulseaudio/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/731a8eff333b8f7053ab2220511b524c87a75923
...
/usr/lib64/libpipewire-0.3.so.0.304.0
