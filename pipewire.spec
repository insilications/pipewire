...
Source0  : https://github.com/PipeWire/pipewire/archive/0.3.24/pipewire-0.3.24.tar.gz
...
%prep
%setup -q -n pipewire-0.3.24
cd %{_builddir}/pipewire-0.3.24
pushd ..
cp -a pipewire-0.3.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616112498
...
cp %{_builddir}/pipewire-0.3.24/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.24/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/1d2540d6544e3a72dd4de79c394aad35e690dc7a
...
/usr/lib64/haswell/libpipewire-0.3.so.0.324.0
...
/usr/lib64/libpipewire-0.3.so.0.324.0
