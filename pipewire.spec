...
%prep
%setup -q -n pipewire-0.3.27
cd %{_builddir}/pipewire-0.3.27
pushd ..
cp -a pipewire-0.3.27 buildavx2
popd
...
cp %{_builddir}/pipewire-0.3.27/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.27/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/1d2540d6544e3a72dd4de79c394aad35e690dc7a
...
/usr/lib64/haswell/libpipewire-0.3.so.0.327.0
...
/usr/lib64/libpipewire-0.3.so.0.327.0
