...
Version  : 0.3.37
Release  : 30
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.37/pipewire-0.3.37.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.37/pipewire-0.3.37.tar.gz
...
%prep
%setup -q -n pipewire-0.3.37
cd %{_builddir}/pipewire-0.3.37
pushd ..
cp -a pipewire-0.3.37 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632411154
...
cp %{_builddir}/pipewire-0.3.37/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.37/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/b20949a01ecd5fc139d843db8a3e3b66b6ab8623
...
/usr/lib64/haswell/libpipewire-0.3.so.0.337.0
...
/usr/lib64/haswell/spa-0.2/bluez5/libspa-codec-bluez5-faststream.so
/usr/lib64/haswell/spa-0.2/bluez5/libspa-codec-bluez5-sbc.so
...
/usr/lib64/libpipewire-0.3.so.0.337.0
