...
Version  : 0.3.21
Release  : 12
URL      : https://github.com/PipeWire/pipewire/archive/0.3.21/pipewire-0.3.21.tar.gz
Source0  : https://github.com/PipeWire/pipewire/archive/0.3.21/pipewire-0.3.21.tar.gz
...
%prep
%setup -q -n pipewire-0.3.21
cd %{_builddir}/pipewire-0.3.21
pushd ..
cp -a pipewire-0.3.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612567420
export GCC_IGNORE_WERROR=1
export CFLAGS="$CFLAGS -fno-lto "
export FCFLAGS="$FFLAGS -fno-lto "
export FFLAGS="$FFLAGS -fno-lto "
export CXXFLAGS="$CXXFLAGS -fno-lto "
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dbluez5-backend-ofono=false \
-Dinstalled_tests=true \
-Dpipewire-jack=false \
-Dudevrulesdir="/usr/lib/udev/rules.d" \
-Dvulkan=false  builddir
ninja -v -C builddir
CFLAGS="$CFLAGS -m64 -march=haswell" CXXFLAGS="$CXXFLAGS -m64 -march=haswell " LDFLAGS="$LDFLAGS -m64 -march=haswell" meson --libdir=lib64/haswell --prefix=/usr --buildtype=plain -Dbluez5-backend-ofono=false \
-Dinstalled_tests=true \
-Dpipewire-jack=false \
-Dudevrulesdir="/usr/lib/udev/rules.d" \
-Dvulkan=false  builddiravx2
...
cp %{_builddir}/pipewire-0.3.21/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.21/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/1d2540d6544e3a72dd4de79c394aad35e690dc7a
...
/usr/lib64/haswell/libpipewire-0.3.so.0.321.0
...
/usr/lib64/libpipewire-0.3.so.0.321.0
