...
Version  : 0.3.25
Release  : 16
URL      : https://github.com/PipeWire/pipewire/archive/0.3.25/pipewire-0.3.25.tar.gz
Source0  : https://github.com/PipeWire/pipewire/archive/0.3.25/pipewire-0.3.25.tar.gz
...
%prep
%setup -q -n pipewire-0.3.25
cd %{_builddir}/pipewire-0.3.25
pushd ..
cp -a pipewire-0.3.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617752825
...
cp %{_builddir}/pipewire-0.3.25/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.25/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/1d2540d6544e3a72dd4de79c394aad35e690dc7a
...
/usr/lib64/haswell/libpipewire-0.3.so.0.325.0
...
/usr/lib64/libpipewire-0.3.so.0.325.0
