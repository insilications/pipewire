...
Version  : 0.3.35
Release  : 28
URL      : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.35/pipewire-0.3.35.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.35/pipewire-0.3.35.tar.gz
...
%prep
%setup -q -n pipewire-0.3.35
cd %{_builddir}/pipewire-0.3.35
pushd ..
cp -a pipewire-0.3.35 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631206147
...
cp %{_builddir}/pipewire-0.3.35/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.35/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/b20949a01ecd5fc139d843db8a3e3b66b6ab8623
