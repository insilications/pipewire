...
Version  : 0.3.23
Release  : 14
URL      : https://github.com/PipeWire/pipewire/archive/0.3.23/pipewire-0.3.23.tar.gz
Source0  : https://github.com/PipeWire/pipewire/archive/0.3.23/pipewire-0.3.23.tar.gz
...
%prep
%setup -q -n pipewire-0.3.23
cd %{_builddir}/pipewire-0.3.23
pushd ..
cp -a pipewire-0.3.23 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614884422
...
cp %{_builddir}/pipewire-0.3.23/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.23/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/1d2540d6544e3a72dd4de79c394aad35e690dc7a
...
/usr/lib64/haswell/libpipewire-0.3.so.0.323.0
