...
Version  : 0.2.4
Release  : 3
URL      : https://github.com/PipeWire/pipewire/archive/0.2.4.tar.gz
Source0  : https://github.com/PipeWire/pipewire/archive/0.2.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1542920723
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --prefix /usr --buildtype=plain   builddir
ninja -v -C builddir

%install
mkdir -p %{buildroot}/usr/share/package-licenses/pipewire
cp LICENSE %{buildroot}/usr/share/package-licenses/pipewire/LICENSE
...
/usr/lib64/libpipewire-0.2.so.1.204.0
...
/usr/share/package-licenses/pipewire/LICENSE
