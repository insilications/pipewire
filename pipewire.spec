...
Version  : 0.3.30
Release  : 22
URL      : https://github.com/PipeWire/pipewire/archive/0.3.30/pipewire-0.3.30.tar.gz
Source0  : https://github.com/PipeWire/pipewire/archive/0.3.30/pipewire-0.3.30.tar.gz
...
%prep
%setup -q -n pipewire-0.3.30
cd %{_builddir}/pipewire-0.3.30
pushd ..
cp -a pipewire-0.3.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623253951
...
cp %{_builddir}/pipewire-0.3.30/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.30/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/b20949a01ecd5fc139d843db8a3e3b66b6ab8623
...
/usr/lib64/haswell/libpipewire-0.3.so.0.330.0
