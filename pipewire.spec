...
Source0  : https://github.com/PipeWire/pipewire/archive/0.3.2/pipewire-0.3.2.tar.gz
...
%prep
%setup -q -n pipewire-0.3.2
cd %{_builddir}/pipewire-0.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585331079
...
cp %{_builddir}/pipewire-0.3.2/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.2/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/1d2540d6544e3a72dd4de79c394aad35e690dc7a
cp %{_builddir}/pipewire-0.3.2/pipewire-pulseaudio/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/731a8eff333b8f7053ab2220511b524c87a75923
...
/usr/lib64/libjack-pw.so
/usr/lib64/libpipewire-0.3.so
/usr/lib64/libpulse-mainloop-glib-pw.so
/usr/lib64/libpulse-pw.so
/usr/lib64/libpulse-simple-pw.so
...
/usr/lib64/libjack-pw.so.0.3.2
/usr/lib64/libpipewire-0.3.so.0
/usr/lib64/libpipewire-0.3.so.0.302.0
/usr/lib64/libpulse-mainloop-glib-pw.so.0.3.2
/usr/lib64/libpulse-pw.so.0.3.2
/usr/lib64/libpulse-simple-pw.so.0.3.2
