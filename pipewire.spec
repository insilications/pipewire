...
Version  : 0.3.7
Release  : 10
URL      : https://github.com/PipeWire/pipewire/archive/0.3.7/pipewire-0.3.7.tar.gz
Source0  : https://github.com/PipeWire/pipewire/archive/0.3.7/pipewire-0.3.7.tar.gz
...
%prep
%setup -q -n pipewire-0.3.7
cd %{_builddir}/pipewire-0.3.7
pushd ..
cp -a pipewire-0.3.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595348292
...
cp %{_builddir}/pipewire-0.3.7/COPYING %{buildroot}/usr/share/package-licenses/pipewire/13641f6e59f451fcd8b6f92b449b91e4265854a5
cp %{_builddir}/pipewire-0.3.7/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/1d2540d6544e3a72dd4de79c394aad35e690dc7a
cp %{_builddir}/pipewire-0.3.7/pipewire-pulseaudio/LICENSE %{buildroot}/usr/share/package-licenses/pipewire/731a8eff333b8f7053ab2220511b524c87a75923
...
/usr/lib64/haswell/libpipewire-0.3.so.0.307.0
/usr/lib64/haswell/pipewire-0.3/jack/libjack.so
/usr/lib64/haswell/pipewire-0.3/jack/libjack.so.0
/usr/lib64/haswell/pipewire-0.3/jack/libjack.so.0.307.0
...
/usr/lib64/haswell/pipewire-0.3/pulse/libpulse.so.0.307.0
